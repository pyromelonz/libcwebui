...
/************************************************************************************
*                                                                                   *
*								DEBUG SETTINGS - ALL ENABLED (Level 10)			*
*                                                                                   *
************************************************************************************/

#define _WEBSERVER_DEBUG_                         10
#define _WEBSERVER_MEMORY_DEBUG_                  10
#define _WEBSERVER_PARAMETER_DEBUG_               10
#define _WEBSERVER_TEMPLATE_DEBUG_                10
#define _WEBSERVER_FILESYSTEM_DEBUG_              10
#define _WEBSERVER_FILESYSTEM_CACHE_DEBUG_        10
#define _WEBSERVER_HEADER_DEBUG_                  10
#define _WEBSERVER_BODY_DEBUG_                    10
#define _WEBSERVER_COOKIE_DEBUG_                  10
#define _WEBSERVER_SESSION_DEBUG_                 10
#define _WEBSERVER_SOCKET_DEBUG_                  10
#define _WEBSERVER_CONNECTION_DEBUG_              10
#define _WEBSERVER_CONNECTION_SEND_DEBUG_         10
#define _WEBSERVER_CACHE_DEBUG_                   10
#define _WEBSERVER_HANDLER_DEBUG_                 10
#define _WEBSERVER_WEBSOCKET_DEBUG_               10
#define _WEBSERVER_WEBSOCKET_STREAMING_DEBUG_     10
#define _WEBSERVER_PROXY_DEBUG_                   10
#define _WEBSERVER_ENGINE_PLUGINS_DEBUG_          10
