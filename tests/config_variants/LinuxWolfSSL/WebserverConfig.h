...
/************************************************************************************
*                                                                                   *
*                               SSL SETTINGS - wolfSSL                              *
*                                                                                   *
************************************************************************************/

#define WEBSERVER_USE_SSL
#define WEBSERVER_USE_WOLFSSL_CRYPTO


#ifndef WEBSERVER_USE_SSL
	#undef WEBSERVER_USE_WOLFSSL_CRYPTO
	#undef WEBSERVER_USE_OPENSSL_CRYPTO
	#undef WEBSERVER_USE_MBEDTLS2_CRYPTO
	#undef WEBSERVER_USE_MBEDTLS3_CRYPTO
#else
	#if !defined(WEBSERVER_USE_WOLFSSL_CRYPTO) && !defined(WEBSERVER_USE_OPENSSL_CRYPTO) && !defined(WEBSERVER_USE_MBEDTLS2_CRYPTO) && !defined(WEBSERVER_USE_MBEDTLS3_CRYPTO)
